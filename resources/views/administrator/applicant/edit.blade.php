                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" required class="form-control" name="min_salary" value="{{$data->range_salary_bottom}}">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="col-md-12">Range Maximum Salary</label>
                                        <input type="number" required class="form-control" name="max_salary" value="{{$data->range_salary_top}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Company Location</label>
                                    <div class="col-md-12">
                                        <input type="text" required class="form-control" name="company_location" value="{{$data->company_location}}">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea class="content" name="description_requirement" id="ckeditor">{{$data->description_requirement}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
