                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select required class="form-control" name="job_title" >
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Job Location</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="deadline" name="deadline" class="form-control datepicker" id="from" placeholder="" autocomplete="off" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea required class="content" name="description" id="ckeditor"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea required class="content" name="requirement" id="ckeditor2"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
