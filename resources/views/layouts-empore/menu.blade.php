               ...
               <nav class="main-menu">
                  <ul id="menu-main-menu" class="site-nav">
                     <!--li class="dropdown-full-width first-level-menu with-dropdown-m hmenu-li hmenu-li-fdrop rd-menu-item menu-item menu-item-has-children">
                        <a class="menu-link" href="{{route('service')}}">IT Services</a>
                        <ul class="sub-menu">
                           ...
                           <li class="title-dropdown-purple second-level-menu hmenu-li-flist rd-menu-item menu-item "> 
                              <a class="menu-link" href="{{ route('custom-software-development') }}">Custom Software Development</a>
                           </li>
                           <li class="title-dropdown-purple second-level-menu hmenu-li-flist rd-menu-item menu-item "> 
                              <a class="menu-link" href="{{ route('saas-application-development') }}">SaaS Application Development</a>
                           </li>
                           <li class="title-dropdown-purple second-level-menu hmenu-li-flist rd-menu-item menu-item "> 
                              <a class="menu-link" href="{{ route('cloud-software-development') }}">Cloud Software Development</a>  
                           </li>
                           <li class="title-dropdown-pink second-level-menu hmenu-li-flist rd-menu-item menu-item"> 
                              <a class="menu-link" href="{{ route('app-modernization-service') }}">Application Enhancement</a>
                           </li>
                           <li class=" menu-item"> 
                              <a class="menu-link" href="{{ route('ui-ux-development-service') }}">UX/UI Development and Design</a>
                           </li>
                           <li class="title-dropdown-pink second-level-menu hmenu-li-flist rd-menu-item menu-item">
                              <a class="menu-link" href="{{ route('cross-platform-app-development') }}">Mobile Application Development</a>
                           </li>
                           <li class="title-dropdown-pink second-level-menu hmenu-li-flist rd-menu-item menu-item">
                              <a class="menu-link" href="{{ route('full-qa-cycle') }}">Full Life Cycle Software Testing</a>
                           </li>
                           <li class="rd-menu-item menu-item">
                              <a class="menu-link" href="{{ route('hire-dedicated-web-developers-team') }}">Dedicated In House Programmer</a>
                           </li>
                           <li class="free-consultation-menu menu-item"> 
                              <a class="menu-link" href="{{ route('free-consultation') }}">Free Consultation</a>
                           </li>
                        </ul>
                     </li-->
                     <!--li class="dropdown-standard first-level-menu with-dropdown-m hmenu-li hmenu-li-stdrop rd-menu-item menu-item menu-item-has-children">
                        <a class="menu-link" href="{{route('service')}}">HR Services</a>
                        <ul class="sub-menu">
                           <li class="menu-item">
