...
<!--    CSS NEW TEMPLATE    -->
<link rel="stylesheet" type="text/css" href="{{ asset('themes-empore/twentyfifteen/css/stylefornewtemplate.css') }}" />
<!--    END CSS NEW TEMPLATE    -->
<link rel='stylesheet' id='home-redesign-style-css'  href="{{ asset('themes-empore/twentyfifteen/css/pages/home/home.min8e5e.css?v=15') }}"" type='text/css' media='all' />
   <body>
         ...
         <div class="xb-global-container" >
                  ...
                  <div class="xb-row">
                     <div class="xb-col-6">
                        <div class="xb-col-8" style="float: right;">
                           <img src="{{ asset('images-empore/new_template/office_table.png') }}" style="width: 100%; height: auto;" >
                        </div>
                     </div>
               ...
               <div class="xb-block">
                  <div class="xb-row">
                     ...
                     <div class="xb-col-6">
                        <div class="xb-row">
                           <div class="xb-col-8">
                              <img src="{{ asset('images-empore/new_template/it_service.png') }}" style="width: 100%; height: auto;">
                           </div>
                        </div>
                        <br>
                        <div class="xb-row">
            ...
            <div style="background-color: #EBEBEB; padding: 0 12%; overflow: hidden; ">
               <div class="xb-block">
                  <div class="xb-col-12">
                     <div class="xb-col-12" style="overflow: hidden;">
                        <a href="www.em-hr.co.id"><img id="slide1" class="fade" style="width: 95%; height: auto; display: none;"  src="{{ asset('images-empore/new_template/slide1.png') }}" ></a>
                        <a href=""><img id="slide2" class="fade" style="width: 95%; height: auto; display: none;"  src="{{ asset('images-empore/new_template/slide2.png') }}" ></a>
                  ...
                  <div class="xb-row">
                     <div class="xb-col-6">
                        <div class="xb-col-12" style="float: right; width: 80%;">
                           ...
                           <br>
                           <div class="xb-col-12">
                              <img class="image-div" id="recruit-img" src="{{ asset('images-empore/new_template/Button-Service.png') }}" >
                           </div>
                     ...
                     <div class="xb-col-6" >
                        <a href="recruitment-and-head-hunting.php" style="text-decoration: none; color: black;">
                           <div class="xb-row" id="slides1" style="display: none;">
                              <img class="image-div" id="recruit-img" src="{{ asset('images-empore/new_template/recruit-img.png') }}" >
                              <br><br>
                              <div class="xb-col-12">
                                 <div class="xb-block">
                        ...
                        <a href="payroll.php" style="text-decoration: none; color: black;">
                           <div class="xb-row" id="slides2" style="display: none;">
                              <img class="image-div" id="payroll-image" src="{{ asset('images-empore/new_template/payroll-image.png') }}" >
                              <br><br>
                              <div class="xb-col-12">
                        ...
                        <a href="contract-and-temporary-staffing.php" style="text-decoration: none; color: black;">
                           <div class="xb-row" id="slides3" style="display: none;">
                              <img class="image-div" id="contract-temporary" src="{{ asset('images-empore/new_template/contract-temporary.png') }}" >
                              <br><br>
                              <div class="xb-col-12">
                                 ...
                                 <div class="core-switcher-body js-core-switcher-body js-activate js-parent-elem">
                                    <div class="core-switcher-row light-font js-core-switch-content" data-content="0">
                                       <div class="core-switcher-row-inside js-core-switcher-row js-child">
                                          <div class="core-switcher-title">LISTEN AND ANALYZE YOUR NEEDS</div>
                  ...
                  <div class="hp-progress-carousel js-progress-carousel"> 
                     <span class="company-progress-block light-font"> 
                        <span class="img-wrap company-progress-block__pict"> 
                           <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="{{ asset('images-empore/client/client_adp.png') }}" alt="" class="company-progress-block__img img-responsive lazy-load js-lazy-load" /> 
                        </span> 
                     ...
                     <a href="" title="" class="company-progress-block light-font" target="_blank"> 
                        <span class="img-wrap company-progress-block__pict"> 
                           <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="{{ asset('images-empore/client/client_aaf.png') }}" alt="" class="company-progress-block__img img-responsive lazy-load js-lazy-load" /> 
                        </span> 
                     ...
                     <a href="" title="" class="company-progress-block light-font" target="_blank"> 
                        <span class="img-wrap company-progress-block__pict"> 
                           <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="{{asset('images-empore/client/client_bali.png')}}" alt="" class="company-progress-block__img img-responsive lazy-load js-lazy-load" /> 
                        </span> 
...
Currently has expanse the business into provider of Internet Protocol Television.
                     ...
                     <a href="" title="" class="company-progress-block light-font" target="_blank"> 
                        <span class="img-wrap company-progress-block__pict"> 
                           <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="{{ asset('images-empore/client/client_compnet.png') }}" alt="" class="company-progress-block__img img-responsive lazy-load js-lazy-load" /> 
                        </span> 
...
The provision of information communication & technologies services reality to project management, design, implementation, and professional services.
                     ...
                     <a href="" title="" class="company-progress-block light-font" target="_blank"> 
                        <span class="img-wrap company-progress-block__pict"> 
                           <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="{{ asset('images-empore/client/client_dc.png') }}" alt="" class="company-progress-block__img img-responsive lazy-load js-lazy-load" /> 
                        </span> 
                     ...
                     <a href="" title="" class="company-progress-block light-font" target="_blank"> 
                        <span class="img-wrap company-progress-block__pict"> 
                           <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="{{ asset('images-empore/client/client_intim.png') }}" alt="" class="company-progress-block__img img-responsive lazy-load js-lazy-load" /> 
                        </span> 
                     ...
                     <a href="" title="" class="company-progress-block light-font" target="_blank"> 
                        <span class="img-wrap company-progress-block__pict"> 
                           <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="{{ asset('images-empore/client/client_nokia.png') }}" alt="" class="company-progress-block__img img-responsive lazy-load js-lazy-load" /> 
                        </span> 
                     ...
                     <a href="" title="" class="company-progress-block light-font" target="_blank"> 
                        <span class="img-wrap company-progress-block__pict"> 
                           <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="{{ asset('images-empore/client/client_praisindo.png') }}" alt="" class="company-progress-block__img img-responsive lazy-load js-lazy-load" /> 
                        </span> 
                     ...
                     <a href="" title="" class="company-progress-block light-font" target="_blank"> 
                        <span class="img-wrap company-progress-block__pict"> 
                           <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="{{ asset('images-empore/client/client_xdana.png') }}" alt="" class="company-progress-block__img img-responsive lazy-load js-lazy-load" /> 
                        </span> 
                     ...
                     <a href="" title="" class="company-progress-block light-font" target="_blank"> 
                        <span class="img-wrap company-progress-block__pict"> 
                           <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="{{ asset('images-empore/client/client_ajri.png') }}" alt="" class="company-progress-block__img img-responsive lazy-load js-lazy-load" /> 
                        </span> 
               ...
               <div class="contact-us-container js-bg" style="background-image: url('{{ asset('images-empore/new_template/background.png') }}');">
                  <div class="contact-us-container-inside top-bottom-60">
                     <div class="xb-block">
                        <div class="xb-row blocks-center">
                           <div class="xb-col-8">
                              <a href="https://unionspace.id/en/terminal3.php" target="_blank">
                                 <img src="{{ asset('images-empore/new_template/Blasting OK.png') }}" style="width: 103%;">
                              </a>
                           </div>
                        </div>
                     </div>
         ...
         <script type='text/javascript' src="{{ asset('themes-empore/twentyfifteen/js/cookies.min68b3.js?ver=1') }}"></script> 
         <script type='text/javascript' src="{{ asset('themes-empore/twentyfifteen/js/all.scriptsf234.js?v=5&amp;ver=20150330') }}"></script> 
         <script type='text/javascript' src='//api-maps.yandex.ru/2.0/?load=package.standard&#038;lang=en-US&#038;ver=1'></script>
         <script type='text/javascript' src="{{ asset('themes-empore/twentyfifteen/js/pages/home/script.min08c8.js') }}"></script>
         <script type='text/javascript' src="{{ asset('themes-empore/twentyfifteen/js/functions5ed1.js?v=132&amp;ver=20150330') }}"></script> 
   </body>
</html>