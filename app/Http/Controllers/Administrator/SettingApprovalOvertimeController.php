...
class SettingApprovalOvertimeController extends Controller
{
    ...
    public function storeItem(Request $request)
    {
        ...
        {
            return redirect()->route('administrator.setting-approvalOvertime.createItem', $request->setting_approval_leave_id)->with('message-error', 'Approval level is incomplete!');
        }elseif ($request->structure_organization_custom_id == NULL) {
            # code...
            return redirect()->route('administrator.setting-approvalOvertime.createItem', $request->setting_approval_leave_id)->with('message-error', 'Approval position is incomplete!');
        }else{


            if(isset($checkDataStruktur))
            {
                return redirect()->route('administrator.setting-approvalOvertime.indexItem', $request->setting_approval_leave_id)->with('message-error', 'Data already exists!');
    ...
    public function updateItem(Request $request, $id)
    {
        ...
        if ($request->structure_organization_custom_id == NULL) {
            # code...
            return redirect()->route('administrator.setting-approvalOvertime.indexItem', $request->setting_approval_leave_id)->with('message-error', 'Approval position is incomplete!');
        }else
        {
            if(isset($checkDataStruktur))
            {
